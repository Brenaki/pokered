...
- **data/maps/objects/CeruleanCity.asm** (3 connections) — `data/maps/objects/CeruleanCity.asm`
- **data/maps/objects/CeruleanMart.asm** (3 connections) — `data/maps/objects/CeruleanMart.asm`
- **data/maps/objects/CeruleanPokecenter.asm** (3 connections) — `data/maps/objects/CeruleanPokecenter.asm`
- **data/maps/objects/CeruleanTrashedHouse.asm** (3 connections) — `data/maps/objects/CeruleanTrashedHouse.asm`
- **data/maps/objects/CinnabarIsland.asm** (3 connections) — `data/maps/objects/CinnabarIsland.asm`
...
- **data/maps/objects/CopycatsHouse1F.asm** (3 connections) — `data/maps/objects/CopycatsHouse1F.asm`
- **data/maps/objects/Daycare.asm** (3 connections) — `data/maps/objects/Daycare.asm`
- *... and 408 more nodes in this community*

## Relationships

- [Scripts 3](Scripts_3.md) (26 shared connections)
...
- `data/maps/headers/BikeShop.asm`
- `data/maps/headers/BillsHouse.asm`
- `data/maps/headers/BluesHouse.asm`
- `data/maps/headers/BrunosRoom.asm`
- `data/maps/headers/CeladonChiefHouse.asm`
- `data/maps/headers/CeladonCity.asm`
- `data/maps/headers/CeladonDiner.asm`
- `data/maps/headers/CeladonGym.asm`
- `data/maps/headers/CeladonHotel.asm`
- `data/maps/headers/CeladonMansion1F.asm`
- `data/maps/headers/CeladonMansion2F.asm`
- `data/maps/headers/CeladonMansion3F.asm`
- `data/maps/headers/CeladonMansionRoof.asm`
- `data/maps/headers/CeladonMansionRoofHouse.asm`
- `data/maps/headers/CeladonMart1F.asm`
- `data/maps/headers/CeladonMart2F.asm`
- `data/maps/headers/CeladonMart3F.asm`
- `data/maps/headers/CeladonMart4F.asm`
- `data/maps/headers/CeladonMart5F.asm`
