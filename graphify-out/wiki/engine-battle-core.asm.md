...
- data/types/type_matchups.asm `EXTRACTED`
- data/battle/critical_hit_moves.asm `EXTRACTED`
- data/battle/special_effects.asm `EXTRACTED`
- data/battle/always_happen_effects.asm `EXTRACTED`
- data/battle/residual_effects_1.asm `EXTRACTED`
- data/battle/residual_effects_2.asm `EXTRACTED`
- data/battle/set_damage_effects.asm `EXTRACTED`
- data/battle/unused_critical_hit_moves.asm `EXTRACTED`
