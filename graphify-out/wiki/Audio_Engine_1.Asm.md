...
- **Audio1_pitch_slide** (10 connections) — `audio/engine_1.asm`
- **Audio1_GetRegisterPointer** (9 connections) — `audio/engine_1.asm`
- **Audio1_note_type** (9 connections) — `audio/engine_1.asm`
- **Audio1_vibrato** (9 connections) — `audio/engine_1.asm`
