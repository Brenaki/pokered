...
- **Facility_Coll** (1 connections) — `data/tilesets/collision_tile_ids.asm`
- **Forest_Coll** (1 connections) — `data/tilesets/collision_tile_ids.asm`
- **ForestGate_Coll** (1 connections) — `data/tilesets/collision_tile_ids.asm`
- **Gate_Coll** (1 connections) — `data/tilesets/collision_tile_ids.asm`
- **Gym_Coll** (1 connections) — `data/tilesets/collision_tile_ids.asm`
- **House_Coll** (1 connections) — `data/tilesets/collision_tile_ids.asm`
- **Interior_Coll** (1 connections) — `data/tilesets/collision_tile_ids.asm`
- **Lab_Coll** (1 connections) — `data/tilesets/collision_tile_ids.asm`
- **Lobby_Coll** (1 connections) — `data/tilesets/collision_tile_ids.asm`
- **Mansion_Coll** (1 connections) — `data/tilesets/collision_tile_ids.asm`
