...
- **engine/overworld/wild_mons.asm** (4 connections) — `engine/overworld/wild_mons.asm`
- **wGrassMons** (4 connections) — `ram/wram.asm`
- **wWaterMons** (4 connections) — `ram/wram.asm`
- **WildMonEncounterSlotChances** (2 connections) — `data/wild/probabilities.asm`
